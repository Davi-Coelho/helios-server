...
DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'Sistema de Votacao Eletronica')
...
# election stuff
SITE_TITLE = get_from_env('SITE_TITLE', _('Sistema de Votacao Eletronica'))
...
WELCOME_MESSAGE = get_from_env('WELCOME_MESSAGE', _('Bem vindo ao Sistema de Votacao Eletronica!'))
